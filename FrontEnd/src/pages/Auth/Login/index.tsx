    ...
    <S.Wrap>
      <S.Content>
        ...
        <Form
          ...
          form={form}
        >
          <S.StyledInput name="username" rules={[{ required: true, message: 'Please input your Username!' }]}>
            <Input prefix={<UserOutlined className="site-form-item-icon" />} placeholder="Username" />
          </S.StyledInput>
          <S.StyledInput name="password" rules={[{ required: true, message: 'Please input your Password!' }]}>
